...
// configuration step. It creates a namespace called `algorithms`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", algorithms::cmake::project_name, algorithms::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", algorithms::cmake::project_version);
      return EXIT_SUCCESS;
    }
